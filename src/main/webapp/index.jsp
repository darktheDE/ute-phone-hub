...
<head>
    ...
    <meta name="description" content="UTE Phone Hub - Cửa hàng điện thoại, laptop, phụ kiện chính hãng với giá tốt nhất. Giao hàng nhanh, bảo hành chính hãng.">
    <meta name="keywords" content="điện thoại, laptop, phụ kiện, iPhone, Samsung, MacBook, iPad">
    ...
    <header class="header">
            ...
            <div class="header-content">
                ...
                <div class="search-container">
                    <div class="search-bar">
                        <input type="text" class="search-input" placeholder="Tìm kiếm điện thoại, laptop, phụ kiện...">
                ...
                <div class="header-actions">
                    <a href="${pageContext.request.contextPath}/api/v1/auth/login" class="header-action">
        ...
        <nav class="nav">
            <div class="nav-container">
                <ul class="nav-list">
                    ...
                    <li class="nav-item">
                        <a href="${pageContext.request.contextPath}/products?category=phone" class="nav-link">
                            <i class="fas fa-mobile-alt"></i>
                            <span>Điện thoại</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="${pageContext.request.contextPath}/products?category=laptop" class="nav-link">
                            <i class="fas fa-laptop"></i>
                            <span>Laptop</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="${pageContext.request.contextPath}/products?category=accessories" class="nav-link">
                            <i class="fas fa-headphones"></i>
                            <span>Phụ kiện</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="${pageContext.request.contextPath}/products?category=smartwatch" class="nav-link">
                            <i class="fas fa-clock"></i>
                            <span>Smartwatch</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="${pageContext.request.contextPath}/products?category=tablet" class="nav-link">
                            <i class="fas fa-tablet-alt"></i>
                            <span>Tablet</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="${pageContext.request.contextPath}/products?category=used" class="nav-link">
                            <i class="fas fa-recycle"></i>
                            <span>Máy cũ</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="${pageContext.request.contextPath}/products?category=monitor" class="nav-link">
                            <i class="fas fa-desktop"></i>
                            <span>Màn hình</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="${pageContext.request.contextPath}/products?category=sim" class="nav-link">
        ...
        <div class="mobile-menu">
            <ul class="mobile-nav-list">
                ...
                <li class="mobile-nav-item">
                    <a href="${pageContext.request.contextPath}/products?category=phone" class="mobile-nav-link">
                        <i class="fas fa-mobile-alt"></i>
                        <span>Điện thoại</span>
                    </a>
                </li>
                <li class="mobile-nav-item">
                    <a href="${pageContext.request.contextPath}/products?category=laptop" class="mobile-nav-link">
                        <i class="fas fa-laptop"></i>
                        <span>Laptop</span>
                    </a>
                </li>
                <li class="mobile-nav-item">
                    <a href="${pageContext.request.contextPath}/products?category=accessories" class="mobile-nav-link">
                        <i class="fas fa-headphones"></i>
                        <span>Phụ kiện</span>
                    </a>
                </li>
                <li class="mobile-nav-item">
                    <a href="${pageContext.request.contextPath}/products?category=smartwatch" class="mobile-nav-link">
                        <i class="fas fa-clock"></i>
                        <span>Smartwatch</span>
                    </a>
                </li>
                <li class="mobile-nav-item">
                    <a href="${pageContext.request.contextPath}/products?category=tablet" class="mobile-nav-link">
                        <i class="fas fa-tablet-alt"></i>
                        <span>Tablet</span>
                    </a>
                </li>
    ...
    <main class="main-content">
        ...
        <section class="hero">
            <div class="hero-content">
                ...
                <p class="fade-in">Cửa hàng điện thoại, laptop và phụ kiện chính hãng với giá tốt nhất</p>
                <div class="hero-buttons fade-in">
                    <a href="${pageContext.request.contextPath}/products" class="btn btn-primary btn-lg">
                        <i class="fas fa-shopping-bag"></i>
                        Mua sắm ngay
                    </a>
                    <a href="${pageContext.request.contextPath}/api/v1/health" class="btn btn-secondary btn-lg">
            ...
            <div class="product-grid">
                ...
                <div class="product-card" data-product-id="samsung-galaxy-a16-5g">
                    <div class="product-image-container">
                        <img src="https://via.placeholder.com/300x200/ff6b35/ffffff?text=Samsung+Galaxy+A16+5G" alt="Samsung Galaxy A16 5G" class="product-image">
                ...
                <div class="product-card" data-product-id="vivo-v40-5g">
                    <div class="product-image-container">
                        <img src="https://via.placeholder.com/300x200/ff6b35/ffffff?text=vivo+V40+5G" alt="vivo V40 5G" class="product-image">
                        <div class="product-badges">
                ...
                <div class="product-card" data-product-id="airpods-max">
                    <div class="product-image-container">
                        <img src="https://via.placeholder.com/300x200/ff6b35/ffffff?text=AirPods+Max" alt="AirPods Max" class="product-image">
                        <div class="product-badges">
                ...
                <div class="product-card" data-product-id="thermal-printer">
                    <div class="product-image-container">
                        <img src="https://via.placeholder.com/300x200/ff6b35/ffffff?text=Máy+in+nhiệt" alt="Máy in nhiệt" class="product-image">
                        <div class="product-badges">
                ...
                <div class="product-card" data-product-id="befit-watch">
                    <div class="product-image-container">
                        <img src="https://via.placeholder.com/300x200/ff6b35/ffffff?text=BeFit+Watch" alt="BeFit Watch" class="product-image">
                        <div class="product-badges">
                    ...
                    <div class="product-info">
                        ...
                        <h3 class="product-title">BeFit Watch Ultra 52.6mm dây silicone</h3>
                        <div class="product-features">
                            <ul class="feature-list">
                                <li class="feature-item">
                                    <i class="fas fa-check"></i>
                ...
                <div class="product-card" data-product-id="realme-c75">
                    <div class="product-image-container">
                        <img src="https://via.placeholder.com/300x200/ff6b35/ffffff?text=realme+C75" alt="realme C75" class="product-image">
                        <div class="product-badges">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="status-actions">
                        <a href="${pageContext.request.contextPath}/api/v1/health" class="btn btn-primary">
                            <i class="fas fa-heartbeat"></i>
                            Kiểm tra API
                        </a>
                        <a href="${pageContext.request.contextPath}/docs/api/postman-collection.json" class="btn btn-secondary">
