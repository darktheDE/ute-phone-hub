          ...
          <ul class="nav-list">
            ...
            <li class="nav-item">
              <a
                ...
                class="nav-link ${param.category == 'phone' ? 'active' : ''}"
              >
            ...
            <li class="nav-item">
              <a
                ...
                class="nav-link ${param.category == 'laptop' ? 'active' : ''}"
              >
            ...
            <li class="nav-item">
              <a
                ...
                class="nav-link ${param.category == 'accessories' ? 'active' : ''}"
              >
            ...
            <li class="nav-item">
              <a
                ...
                class="nav-link ${param.category == 'smartwatch' ? 'active' : ''}"
              >
            ...
            <li class="nav-item">
              <a
                ...
                class="nav-link ${param.category == 'tablet' ? 'active' : ''}"
              >
      ...
      <div class="product-filters">
        <div class="filter-group">
          ...
          <div class="filter-options">
            <div
              class="filter-option ${param.category == 'phone' ? 'active' : ''}"
            ...
            <div
              class="filter-option ${param.category == 'laptop' ? 'active' : ''}"
              data-filter="category"
              data-value="laptop"
            >
              <i class="fas fa-laptop"></i>
            ...
            <div
              class="filter-option ${param.category == 'accessories' ? 'active' : ''}"
              data-filter="category"
            ...
            <div
              class="filter-option ${param.category == 'smartwatch' ? 'active' : ''}"
              data-filter="category"
            ...
            <div
              class="filter-option ${param.category == 'tablet' ? 'active' : ''}"
              data-filter="category"
              data-value="tablet"
            >
              <i class="fas fa-tablet-alt"></i>
        ...
        <div class="filter-group">
          ...
          <div class="filter-options">
            <div class="filter-option" data-filter="brand" data-value="apple">
              Apple
            </div>
            <div class="filter-option" data-filter="brand" data-value="samsung">
              Samsung
            </div>
            <div class="filter-option" data-filter="brand" data-value="xiaomi">
              Xiaomi
            </div>
            <div class="filter-option" data-filter="brand" data-value="oppo">
              OPPO
            </div>
            <div class="filter-option" data-filter="brand" data-value="vivo">
              vivo
            </div>
            <div class="filter-option" data-filter="brand" data-value="realme">
              realme
            </div>
          </div>
        </div>
        ...
        <div class="filter-group">
          ...
          <div class="filter-options">
            ...
            <div class="filter-option" data-filter="sort" data-value="rating">
              Đánh giá cao
            </div>
            <div class="filter-option" data-filter="sort" data-value="popular">
              Bán chạy
            </div>
          </div>
        </div>
        ...
        <div class="product-grid" id="productGrid">
          ...
          <div class="product-card" data-product-id="iphone-15-pro-max">
            <div class="product-image-container">
              <img
                src="https://via.placeholder.com/300x200/ff6b35/ffffff?text=iPhone+15+Pro+Max"
          ...
          <div class="product-card" data-product-id="samsung-galaxy-s24-ultra">
            <div class="product-image-container">
              <img
                src="https://via.placeholder.com/300x200/ff6b35/ffffff?text=Samsung+Galaxy+S24+Ultra"
          ...
          <div class="product-card" data-product-id="macbook-pro-m3">
            <div class="product-image-container">
              <img
                src="https://via.placeholder.com/300x200/ff6b35/ffffff?text=MacBook+Pro+M3"
                alt="MacBook Pro M3"
                class="product-image"
              />
              <div class="product-badges">
          ...
          <div class="product-card" data-product-id="airpods-pro-2">
            <div class="product-image-container">
              <img
                src="https://via.placeholder.com/300x200/ff6b35/ffffff?text=AirPods+Pro+2"
                alt="AirPods Pro 2"
                class="product-image"
              />
              <div class="product-badges">
          ...
          <div class="product-card" data-product-id="apple-watch-series-9">
            <div class="product-image-container">
              <img
                src="https://via.placeholder.com/300x200/ff6b35/ffffff?text=Apple+Watch+Series+9"
          ...
          <div class="product-card" data-product-id="ipad-air-m2">
            <div class="product-image-container">
              <img
                src="https://via.placeholder.com/300x200/ff6b35/ffffff?text=iPad+Air+M2"
                alt="iPad Air M2"
                class="product-image"
              />
              <div class="product-badges">
