...
public class RedisService {
    ...
    public void storeRefreshToken(String email, String refreshToken) {
        try (Jedis jedis = RedisConfig.getJedis()) {
            ...
            logger.debug("Stored refresh token for user: {}", email);
        } catch (Exception e) {
    ...
    public void deleteRefreshToken(String email) {
        try (Jedis jedis = RedisConfig.getJedis()) {
            String key = REFRESH_TOKEN_PREFIX + email;
            jedis.del(key);
            logger.debug("Deleted refresh token for user: {}", email);
        } catch (Exception e) {
    ...
    public void storeForgotPasswordOTP(String email, String otp) {
        try (Jedis jedis = RedisConfig.getJedis()) {
            ...
            logger.debug("Stored forgot password OTP for user: {}", email);
        } catch (Exception e) {
    ...
    public boolean verifyForgotPasswordOTP(String email, String otp) {
        try (Jedis jedis = RedisConfig.getJedis()) {
            ...
            if (storedOtp != null && storedOtp.equals(otp)) {
                logger.debug("Verified forgot password OTP for user: {}", email);
                return true;
            }
            
            logger.warn("Invalid or expired forgot password OTP for user: {}", email);
            return false;
        } catch (Exception e) {
    ...
    public void deleteForgotPasswordOTP(String email) {
        try (Jedis jedis = RedisConfig.getJedis()) {
            String key = FORGOT_PASSWORD_PREFIX + email;
            jedis.del(key);
            logger.debug("Deleted forgot password OTP for user: {}", email);
        } catch (Exception e) {
    ...
    public void setResendCooldown(String email) {
        try (Jedis jedis = RedisConfig.getJedis()) {
            ...
            logger.debug("Set resend cooldown for user: {}", email);
        } catch (Exception e) {
    ...
    public int incrementOTPAttempts(String email) {
        try (Jedis jedis = RedisConfig.getJedis()) {
            ...
            logger.debug("OTP verification attempts for {}: {}", email, attempts);
    ...
    public void clearOTPAttempts(String email) {
        try (Jedis jedis = RedisConfig.getJedis()) {
            ...
            logger.debug("Cleared OTP attempts for user: {}", email);
        } catch (Exception e) {
    ...
    public void storeEmailVerificationCode(String email, String code) {
        try (Jedis jedis = RedisConfig.getJedis()) {
            ...
            logger.debug("Stored email verification code for user: {}", email);
        } catch (Exception e) {
    ...
    public boolean verifyEmailCode(String email, String code) {
        try (Jedis jedis = RedisConfig.getJedis()) {
            ...
            if (storedCode != null && storedCode.equals(code)) {
                jedis.del(key);
                logger.debug("Verified email code for user: {}", email);
                return true;
            }
            
            logger.warn("Invalid or expired email verification code for user: {}", email);
            return false;
        } catch (Exception e) {
